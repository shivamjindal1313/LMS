                ...
                <div className="main__cards">
                    <div className="card">{/* === CARDS === */}
                        ...
                        <div className="card_inner">
                            <p className="text-primary-p">Number of Womens</p>
                    ...
                    <div className="card">{/* === CARDS === */}
                        ...
                        <div className="card_inner">
                            <p className="text-primary-p">Number of Active Womens</p>
                    ...
                    <div className="card">{/* === CARDS === */}
                        ...
                        <div className="card_inner">
                            <p className="text-primary-p">Average number of active per region</p>
