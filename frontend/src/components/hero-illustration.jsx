        ...
        >
          <defs>
            <radialGradient
              ...
              id="ball-1-a"
            >
              <stop stopColor="#D3C3DF" offset="0%" />
              <stop stopColor="#E078CE" offset="34.827%" />
              <stop stopColor="#e10c82" offset="100%" />
            </radialGradient>
          </defs>
      ...
      >
        ...
        >
          <defs>
            ...
            >
              <stop stopColor="#D3C3DF" offset="0%" />
              <stop stopColor="#E078CE" offset="100%" />
            </linearGradient>
            <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="browser-f">
              <stop stopColor="#E078CE" offset="0%" />
              <stop stopColor="#e10c82" offset="100%" />
            </linearGradient>
